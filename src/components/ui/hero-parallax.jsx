...
import { ButtonBorderGradient } from "../shared/ButtonBorderGradient";
  ...
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0 text-black" dir="rtl">
      ...
      <p className="max-w-2xl md:text-xl mt-8 dark:text-neutral-200">
        موقع متخصص في تقديم حلول لغوية متقدمة للغة العربية، يهدف إلى مساعدة
        المستخدمين في تحسين جودة نصوصهم وتقديم أدوات فعالة لتشكيل النصوص،
        الإعراب، والتدقيق اللغوي
      </p>
      <div className="mt-4">
        <TypewriterEffect />
      </div>
